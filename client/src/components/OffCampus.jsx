...
const OffCampus = () => {
  ...
  const fetchJobs = async () => {
    ...
    try {
      const response = await axios({
        method: 'get',
        url: 'https://biet-tnp-server.vercel.app/api/user/offcampus',
      ...
      setJobs(response.data);  // Set jobs here
  ...
  return (
   <>
    <div className='bg-black -z-50 text-white my-[3%]  flex flex-col text-center'>
